...
//            Text(text = newsArticle.summary, maxLines = 4, overflow = TextOverflow.Ellipsis)
//            Text(text = newsArticle.link, color = Color.Blue, modifier = Modifier.clickable { /* Open URL in browser */ })
//        }
//    }
//}